    ...
    if (isset($_POST['delete'])) {
        if (isset($_POST['selectedProducts']) && is_array($_POST['selectedProducts'])) {
            foreach ($_POST['selectedProducts'] as $selectedProductId) {
                $delete_product = $oop->delete_order($selectedProductId);
            }
...
<body>
    ...
    <section >
            <table>
                ...
                <tr>
                    ...
                    <td>
                    <a href="delete.php?ID=<?php $id ?>" class="add">Delete</a>
                    </td>
                <?php
                    }
                }
            ...
            <form method="POST" enctype="multipart/form-data">
                <button class="add" type="button" onclick="complete()" style="margin: auto;">Receipt</button>
            </form> 
    </section>
    </main>
    ...
    <script>
        ...
        xhr.send('action=completeOrders&selectedProducts=' + productIds.join(','));

        // Open the link in a new tab
        window.open('complete_order.php', '_blank');
